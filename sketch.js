...
function draw() {
  ...
  rect(0, 0, 700, 20);
  pop();
  rect(pin1.position.x, pin1.position.y, 30, 50)
  rect(pin2.position.x, pin2.position.y, 30, 50)
  rect(pin3.position.x, pin3.position.y, 30, 50)
  rect(pin4.position.x, pin4.position.y, 30, 50)
  rect(pin5.position.x, pin5.position.y, 30, 50)
  rect(pin6.position.x, pin6.position.y, 30, 50)
